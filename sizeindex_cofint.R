...
si_pred <- predict(si_mod, newdata = data.frame(logvol = volseq), se.fit=TRUE)
...
lines(volseq, si_upr, lty=2, lwd=2,col="royalblue")
lines(volseq, si_lwr, lty=2, lwd=2,col="royalblue")
lines(volseq, si_pred$fit, lty=1, lwd=2,col="royalblue")
