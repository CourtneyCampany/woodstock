...
png(filename = "hia_meeting/img/si_95pred.png", width = 11, height = 8.5, units = "in", res= 600)
...
legend(x=.93, y= 3.63,"95% Prediction Interval" ,lty=2, lwd=2,bty='n', col="royalblue", inset=.01)
